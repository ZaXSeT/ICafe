...
export default function AboutPage() {
  return (
    <div className="flex-1 pt-32 pb-12 bg-background">
      <div className="container mx-auto px-4 md:px-8 max-w-6xl">
        
        {/* Header */}
        <div className="text-center max-w-3xl mx-auto mb-12">
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-heading font-bold mb-4 pb-2 md:pb-4 text-foreground">Our Story</h1>
